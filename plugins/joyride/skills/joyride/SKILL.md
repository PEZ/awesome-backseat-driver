---
name: joyride
description: 'Write effective Joyride scripts and source files in ClojureScript. Use when doing any Joyride related work. Use when using Backseat Driver tools with Joyride.'
---
